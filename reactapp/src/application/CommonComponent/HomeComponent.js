    ...
    render(){
        ...
        return(
            <div className={"loadimage form"} >
                ...
                <b className="feature">{"Welcome to RashidTech's Shopping Cart!"}</b>
                {/* <ul>                     
                    <li>Sign up new users</li>
                    <li>Login to existing users</li>                
                    <li>Allow user's to add to items and/or products to their cart</li>
                    <li>Save the user's cart</li>
                    <li>Allow users to checkout and pay for items</li>
                    <li>Allow users to cancel the order</li>
                    <li>Allow users to reorder</li>
                    <li>Add products/items to create a product collection</li>
                    <li>Allow users to give ratings to each product and/or items</li>
                    <li>Have notifications on top right of the webpage with the option to logout</li>
                </ul> */}
